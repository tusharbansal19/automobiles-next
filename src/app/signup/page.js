                ...
                <div className="absolute inset-0 flex flex-col justify-between p-16 z-10 text-white">
                    ...
                    <div className="max-w-xl">
                        ...
                        <p className="text-xl text-gray-200 font-medium leading-relaxed mb-8">
                            "Join our exclusive community for premium auto care and personalized services."
                        </p>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 lg:p-24 bg-white">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-gray-500 text-lg">Join us today for a better experience.</p>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <FaUser className="absolute left-0 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-red-600 transition-colors pointer-events-none" />
                                <input
                                    type="text"
                                    value={name}
