...
export default function AboutUs() {
  ...
  return (
    <div className="bg-gradient-to-r from-black to-blue-950 min-h-screen text-white  md:flex gap-x-4  justify-center items-center pt-5 px-2 pb-5 ">
      {/* Top Section with Shop Image */}
      <div className="relative w-full h-full  overflow-hidden rounded-lg  pt-4">
        <img
          src="\Image\shopImg.jpg"
          alt="Our Shop"
          className="w-full h-full max-h-[1000px]  object-cover rounded-lg transition-transform duration-500 hover:scale-105"
        />
