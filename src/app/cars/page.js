...
export default function CarPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 py-6 px-4 lg:px-8">
      {/* Header with Filter Button */}
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-4xl font-bold text-white mb-2">Premium Cars</h1>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 text-white px-6 py-3 rounded-full shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-blue-500/25"
        >
      ...
      <aside
        className={`
          fixed top-0 right-0 h-full w-80 max-w-full bg-slate-900/95 backdrop-blur-xl border-l border-blue-500/30 p-6 space-y-6 z-50 transition-transform duration-300 shadow-2xl
