...
export default function ContactUs() {
  ...
  className="w-full h-72 rounded-lg shadow-lg border border-blue-500 hover:shadow-xl transition-shadow duration-300 ease-in-out"
...
></iframe>
      ...
      <div className="mt-12 bg-blue-950 bg-opacity-20 p-8 rounded-xl shadow-lg border border-blue-600 transition-transform transform hover:-translate-y-1">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-blue-950 text-white border border-blue-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition-transform transform hover:-translate-y-1"
            ...
            <div>
              <button
                type="submit"
                className="w-full bg-blue-600 hover:bg-blue-500 text-white font-semibold py-2 rounded-lg transition-transform transform hover:scale-105 duration-300"
              >
                Send Message
              </button>
            </div>
